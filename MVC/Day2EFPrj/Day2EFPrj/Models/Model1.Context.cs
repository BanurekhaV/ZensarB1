...
namespace Day2EFPrj.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "fn_GetCustomersByCountry")]
        public virtual IQueryable<fn_GetCustomersByCountry_Result> fn_GetCustomersByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetCustomersByCountry_Result>("[NorthwindEntities].[fn_GetCustomersByCountry](@country)", countryParameter);
        }
    
        [DbFunction("NorthwindEntities", "GetAllCustomersByCountry")]
        public virtual IQueryable<GetAllCustomersByCountry_Result> GetAllCustomersByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetAllCustomersByCountry_Result>("[NorthwindEntities].[GetAllCustomersByCountry](@country)", countryParameter);
        }
