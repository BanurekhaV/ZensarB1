...
namespace LINQPrj
{
    ...
    partial void DeleteRegion1(Region1 instance);
		...
		public NorthwindContext() : 
				base(global::LINQPrj.Properties.Settings.Default.NorthwindConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnRegionIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Region1_Territories", Storage="_Region1", ThisKey="RegionID", OtherKey="RegionID", IsForeignKey=true)]
    ...
    partial void OnRegionDescriptionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Region1_Territories", Storage="_Territories", ThisKey="RegionID", OtherKey="RegionID")]
		public EntitySet<Territories> Territories
		{
			get
			{
